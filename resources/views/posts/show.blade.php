               ...
               @if ($userPost)
                <div class="row mb-4">
                    ...
                    <form action="{{ route('posts.destroy', ['post' => $post->id])}}" method="POST"
                        onsubmit="return confirm('Postni o\'chirishni xoxlaysizmi?');"
                        >
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-sm btn-outline-danger">O'chirib tashlash</button>
                    </form>
                </div>
               @endif
               ...
               <div class="mb-5">
                   ...
                   <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                       ...
                       <div class="d-flex flex-column pl-3">
                           <a class="text-dark mb-2" href="{{ route('posts.show', ['post' => $item->id])}}">{{ $item->title }}</a>
                           <div class="d-flex">
